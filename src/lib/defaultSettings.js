export const DEFAULT_SETTINGS = {
  ...
  hero: {
    ...
    buttonLink: '/catalog',
    secondaryTitle: 'LIMITED PICKS',
    secondarySubtitle: 'JUST FOR YOU',
  },
  footer: {
    description:
...
<p>At ShopHub, we want you to love your purchase. If you are not completely satisfied, you may request a return within 7 days of delivery.</p>
<h3>Eligibility</h3>
...
<p>ShopHub respects your privacy. We collect information you provide when placing orders, subscribing to our newsletter, or contacting us.</p>
<h3>Information We Collect</h3>
<ul><li>Name, email, phone number, and shipping address</li><li>Order history and preferences</li><li>Newsletter subscription data</li></ul>
<h3>How We Use Your Information</h3>
<p>We use your information to process orders, communicate about your purchases, send promotional updates (with your consent), and improve our services. We never sell your personal data to third parties.</p>`,
    },
  },
  homepage: {
    ...
    compareTitle: 'COMPARE & CHOOSE YOUR PERFECT SAREE',
    compareSubtitle: 'Handpicked collections designed for weddings, festivals, parties, and every special moment.',
    aboutTitle: 'ELEGANCE IN EVERY DRAPE',
    aboutSections: [
      { title: 'CURATED WITH CARE', text: 'Every saree at ShopHub is thoughtfully handpicked with a focus on elegance, comfort, quality, and timeless style rather than mass-produced quantity.' },
      { title: 'CRAFTED TO STAND OUT', text: 'Each saree is selected for its unique design, rich detailing, and elegant finish blending traditional artistry with modern sophistication for a truly timeless look.' },
      { title: 'FOR EVERY OCCASION', text: "Whether it's a wedding, festive celebration, party, or everyday elegance, our collections are designed to make every woman feel confident, beautiful, and special." },
    ],
    lookbookItems: [
      { title: 'Premium Sarees', subtitle: 'TIMELESS ELEGANCE', image: 'https://source.unsplash.com/800x600/?fashion,clothing/s/files/1/0680/6536/1968/files/DSC2443.jpg?v=1781861351', link: '/catalog?category=Silk' },
  ...
  contact: {
    title: 'Contact Us',
    description: 'We would love to hear from you. Reach out for order assistance, styling advice, or partnership inquiries.',
    showForm: true,
  },
  coupons: [],
  seeded: false,
